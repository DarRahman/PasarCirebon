...
1. **Pipeline ETL & Automated Scraping (`update_harian.py`)**
   * Berjalan secara terjadwal otomatis (Cron Job / GitHub Actions) setiap hari pada pukul **13:00 WIB**.
...
2. **Dashboard Interaktif (`app.py`)**
   ...
   * Modul visual: Tren Harga Aktual, Deteksi Anomali (Audit Trail), Disparitas Pasar, Kualitas Data, dan Tanya Jawab AI (Natural Language Query / Text-to-Pandas).
...
* `README.md`: Dokumentasi petunjuk penggunaan berbahasa Inggris.
* `README.id.md`: Dokumentasi petunjuk penggunaan berbahasa Indonesia.
